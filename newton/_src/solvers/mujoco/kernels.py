...
from ...sim.articulation import body_com_world_offset, com_twist_to_point_velocity, origin_twist_to_com_twist
    ...
    for i in range(joint_start, joint_end):
        ...
        if type == JointType.FREE or type == JointType.DISTANCE:
            linear_joint_origin = linear_joint_world - wp.cross(
                angular_joint_world, body_com_world_offset(X_wc, body_com[child])
            )
        else:
